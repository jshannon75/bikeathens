...
lyr_Positron_0.setVisible(true);lyr_BulldogBikeShare_1.setVisible(false);lyr_Trainingpointsofinterest_2.setVisible(true);lyr_Hererouting_3.setVisible(true);lyr_Mapboxrouting_4.setVisible(true);lyr_Googlerouting_5.setVisible(true);
var layersList = [lyr_Positron_0,lyr_BulldogBikeShare_1,lyr_Trainingpointsofinterest_2,lyr_Hererouting_3,lyr_Mapboxrouting_4,lyr_Googlerouting_5];
...
lyr_Googlerouting_5.on('precompose', function(evt) {
